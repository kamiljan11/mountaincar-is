...
const dict: Record<Lang, Record<string, string>> = {
  ...
  is: {
    ...
    "fleet.kicker": "Bílaflotinn okkar", "fleet.title": "Finndu fullkomna bílinn", "fleet.requestQuote": "Fá verðtilboð", "fleet.d1": "Klassíska valið. Þægilegur og áreiðanlegur bíll til að ferðast um Ísland og Ring Road.", "fleet.d2": "Þægindi Duster ásamt þaktjaldi — tilbúinn í útilegu.", "fleet.d3": "Rúmgóður húsbíll með beinskiptingu og öllu því nauðsynlega fyrir ferðalagið þitt.", "fleet.d4": "Nettur húsbíll fyrir 4–5 manns. Þaktjald, tjaldbúnaður, frítt WiFi — fullkominn fyrir pör eða litla hópa.", "fleet.d5": "Rúmgóður 9 manna bíll — fullkominn fyrir hópa, fjölskyldur og flugvallarferðir með nóg pláss fyrir farangur.", "spec.Seats": "Sæti", "spec.Doors": "Hurðir", "spec.Fuel": "Eldsneyti", "spec.Gearbox": "Gírkassi", "spec.Cargo": "Farangursrými", "spec.AC": "Loftkæling", "spec.Engine": "Vél", "spec.Drive": "Drif", "spec.Tent": "Tjald", "spec.WiFi": "WiFi", "val.Manual": "Beinskiptur", "val.Rooftop": "Þaktjald", "val.Free": "Frítt",
